...
const CATEGORY_LABELS: Readonly<Record<AbuseReportCategory, string>> = Object.freeze({
  counterfeit: "Selling counterfeits",
  prohibited_item: "Prohibited items",
  misleading_listing: "Misleading listings",
  unsafe_product: "Unsafe products",
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg gap-4">
        <DialogHeader>
          ...
          <DialogDescription>
            Tell us what is wrong. Pick everything that applies.
          </DialogDescription>
        </DialogHeader>
        ...
        {isAuthenticated ? (
          <>
            ...
            <DialogFooter>
              ...
              >
                <Text>{submit.isPending ? "Sending…" : "Send report"}</Text>
              </Button>
            </DialogFooter>
          </>
        ) : (
