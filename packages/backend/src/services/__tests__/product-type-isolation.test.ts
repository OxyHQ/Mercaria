...
const COMMERCE_REFERENCE =
  /services\/payments\/|\.\.\/payments\/|services\/ranking\/|\.\.\/ranking\/|db\/payments\/|db\/ranking\/|ledgerRepository|inventoryRepository|adjustInventory|reserveInventory|paymentService|rankOffers|evaluateOfferEligibility|ledger_entries|inventory_levels/;
...
describe('#454: a relative import cannot walk around these detectors', () => {
  it('COMMERCE_REFERENCE sees a sibling-relative import', () => {
    expect(
