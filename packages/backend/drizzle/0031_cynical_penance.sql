...
-- oxy:rollback=restore: attribute_reindex_requests_reason_check and native_listing_links_method_check are widened here; the previous forms are in 0024 and 0022 and re-adding either fails against rows carrying the values this file admitted
