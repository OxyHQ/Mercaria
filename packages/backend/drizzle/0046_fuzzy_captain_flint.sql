...
-- oxy:rollback=restore: five CHECKs including orders_seller_type_check and ledger_entries_account_check are widened for mercaria_retail; the previous forms are in 0002, 0033 and 0011, and re-adding any of them fails against a retail order or a retail_cost_recovery entry
--
