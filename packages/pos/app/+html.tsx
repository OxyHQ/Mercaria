  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="title" content="Mercaria POS" />
        <meta
          name="description"
          content="Mercaria POS — take in-person sales: catalog register, cart, customers, charge and receipts."
        />
        ...
        <meta name="apple-mobile-web-app-title" content="Mercaria POS" />
