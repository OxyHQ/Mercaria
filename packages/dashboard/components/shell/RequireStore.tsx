...
/**
 * Guard for store-scoped screens. It:
 *  - waits for the persisted active-store selection to rehydrate,
 *  - redirects to the store picker (`/stores`) when no store is active or the
 *    selected store is no longer one the caller belongs to,
