# Guest commerce: sessions, cart and inline checkout

The guest half of ADR 0003, up to the point a guest order exists. What
happens after it is `docs/orders-buyers.md` (#106), `docs/guest-portal.md`
(#108), `docs/guest-claims.md` (#109) and `docs/guest-governance.md` (#111).
